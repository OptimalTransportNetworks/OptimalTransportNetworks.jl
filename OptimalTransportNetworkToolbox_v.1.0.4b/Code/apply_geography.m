...
for i=1:sz(1)
    if ~isinf(options.along_obstacle_delta_i) && ~isinf(options.along_obstacle_delta_tau)
        ...
        graph.delta_tau(geography.obstacles(i,2),geography.obstacles(i,1))=options.along_obstacle_delta_tau*graph.delta_tau(geography.obstacles(i,2),geography.obstacles(i,1));
